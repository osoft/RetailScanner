package net.zalio.android.utils;
...
public class MyLog {
	...
	static final private String TAG = "rs";
    ...
    static private boolean sFlag;

    static{
        iFlag = dFlag = vFlag = true;
        wFlag = true;
        eFlag = true;
        sFlag = true;
    }
    ...
    public static final void i(String tag, String content){
        if(iFlag)
            Log.i(TAG, tag + COLON_SEPARATOR + content);
    }
    
    public static final void d(String tag, String content){
        if(dFlag)
            Log.d(TAG, tag + COLON_SEPARATOR + content);
    }
    
    public static final void w(String tag, String content){
        if(wFlag)
            Log.w(TAG, tag + COLON_SEPARATOR + content);
    }
    
    public static final void e(String tag, String content){
        if(eFlag)
            Log.e(TAG, tag + COLON_SEPARATOR + content);
    }
    
    public static final void v(String tag, String content){
        if(vFlag)
            Log.v(TAG, tag + COLON_SEPARATOR + content);
    }

    public static final void s(String tag, String content){
        if(sFlag)
            Log.v(TAG, tag + COLON_SEPARATOR + content);
    }
